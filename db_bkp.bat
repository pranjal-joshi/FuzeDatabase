...
PowerShell -NoProfile -ExecutionPolicy Bypass -Command "Compress-Archive -Path 'E:\FuzeDatabase_backups\databases.%TIMESTAMP%.sql' -DestinationPath 'E:\FuzeDatabase_backups\databases.%TIMESTAMP%.zip' -Update"
