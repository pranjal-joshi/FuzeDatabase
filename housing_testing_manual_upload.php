<?php
	...
	if($_SERVER["REQUEST_METHOD"] == "POST"){
		...
		$sqlAdd = "REPLACE INTO `housing_table` (`pcb_no`, `i`, `vee`, `vbat_pst`, `pst_amp`, `pst_wid`, `mod_freq`, `mod_dc`, `mod_ac`, `vrf_amp`, `vbat_vrf`, `cap_charge`, `det_wid`, `det_amp`, `cycles`, `bpf_dc`, `bpf_ac`, `sil`, `vbat_sil`, `lvp`, `bpf_noise_dc`, `bpf_noise_ac`, `pd_delay`, `pd_det`, `safe`, `result`, `op_name`) VALUES (";
